 ...
 *
 * Build status: P0 (scaffold + diagnostics + settings + prompt library). Generation, compression and
 * attachment land in P1 to P5. See README.md.
 */
